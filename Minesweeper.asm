...
;matrix[]=2 =>are flag peste patrat(am renuntat la flaguri, dificultatea nu cere oricum)
;matrix[]=1 =>se deseneaza doar patrat
;matrix[]=0 =>nu se afiseaza patratul si doar numarul de bombe din jur/simbolul de bomba
...
random_generator proc	;in edx(dl) lasa un random 0->9
	push ebp
	mov ebp, esp
...
bomb_generator proc
	...
	mov matrix[0][edx], 3
	mov matrix_rand[0], dl
	
	call random_generator
	mov matrix[10][edx], 3
	mov matrix_rand[1], dl
	
	call random_generator
	mov matrix[20][edx], 3
	mov matrix_rand[2], dl
	
	call random_generator
	mov matrix[30][edx], 3
	mov matrix_rand[3], dl
	
	call random_generator
	mov matrix[40][edx], 3
	mov matrix_rand[4], dl
	
	call random_generator
	mov matrix[50][edx], 3
	mov matrix_rand[5], dl
	
	call random_generator
	mov matrix[60][edx], 3
	mov matrix_rand[6], dl
	
	call random_generator
	mov matrix[70][edx], 3
	mov matrix_rand[7], dl
	
	call random_generator
	mov matrix[80][edx], 3
	mov matrix_rand[8], dl
	
	call random_generator
	mov matrix[90][edx], 3
	mov matrix_rand[9], dl
...
start:
	...
	mov edx, 0
	mov dl, matrix_rand[0]
	mov matrix[0][edx], 1
	
		
	mov edx, 0
	mov dl, matrix_rand[1]
	mov matrix[10][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[2]
	mov matrix[20][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[3]
	mov matrix[30][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[4]
	mov matrix[40][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[5]
	mov matrix[50][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[6]
	mov matrix[60][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[7]
	mov matrix[70][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[8]
	mov matrix[80][edx], 1
		
	mov edx, 0
	mov dl, matrix_rand[9]
	mov matrix[90][edx], 1
